<template>
  <v-container class="custom-layout">
    ...
    <div style="margin-top:40px">
      ...
      <v-layout row>
        <v-flex xs12>
          <p>‘Regular Marijuana Use Linked to More Sex’ screamed the headline. That certainly got my attention. I took the bait and clicked -- for editorial research purposes only, of course. This sexy newsflash is courtesy of Stanford University whose researchers analyzed data and found a positive association between the two.</p>
          <p>Evidently, this is the first study to examine the relationship between cannabis use and frequency of sexual intercourse in the United States. Stanford University School of Medicine’s findings, published last fall in the Journal of Sexual Medicine, are based on an analysis of more than 50,000 Americans ages 25-45. The study’s results are clear. “Frequent marijuana use doesn’t seem to impair sexual motivation or performance. If anything, it’s associated with increased coital frequency,” said the study’s senior author, Michael Eisenberg, MD, assistant professor of urology. Hmmm....it appears I have some research of my own to do. </p>
          <p>The study does not establish a causal connection between cannabis use and sexual activity, Eisenberg noted. But the results hint at it. “The overall trend we saw applied to people of both sexes and all races, ages, education levels, income groups and religions, every health status, whether they were married or single and whether or not they had kids.”</p>
          <p>Some 24.5 percent of men and 14.5 percent of women in the analysis reported having used cannabis, and there was a positive association between the frequency of cannabis use and the frequency of sexual intercourse. This relationship applied to both sexes: Women denying marijuana use in the past year, for example, had sex on average 6.0 times during the previous four weeks, whereas that number was 7.1 for daily cannabis users. Among men, the corresponding figure was 5.6 for nonusers and 6.9 for daily users.</p>
          <p>In other words, cannabis users are having about 20 percent more sex than pot abstainers, Eisenberg noted. So, there you have it -- enough evidence that it is certainly worthy of an investigation of your own, which is especially serendipitous with Valentine’s Day just around the corner. </p>
          <p>When this research came out last fall, I decided it was high time we did a Love issue. I had no end of volunteers who had plenty to share in the way of their own experiences with sex and cannabis. While at the MJBizCon last November, I met Sexuality Educator Ashley Manta of CannaSexual.com who was a wealth of information on the topic and authored the feature ‘Smoke Signals: A romantic roadmap for creating a sensual evening with your partner’ in this month’s issue on page 23. Ashley offers great insight and tips for both the novice and the more experienced. </p>
          <p>Also in this issue, Antuanette Gomez, founder of Pleasure Peaks, elevates our conversation with some bedroom advice of her own with some how-to’s for incorporating cannabis into your love life. We also have a firsthand account from Sin City Melody Jane about the way cannabis changed her relationship with her husband in her story ‘Unlocking Pandora’s Box,’ page 17. There’s also some gifting ideas for February 14th, a recipe from Kynd Cannabis Company for Chocolate Date Truffles in this month’s Cooking with Cannabis, and a product review of favorites from local industry experts who were happy to share their preferred strains in ‘Spreading the Canna-Love.’ </p>
          <p>Speaking of...spread a little love of your own this month, </p>
